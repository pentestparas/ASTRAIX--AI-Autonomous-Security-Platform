...
VULN_PATTERNS: list[tuple[str, str]] = [
    ...
    (r"llm0?\d|owasp llm", "OWASP LLM Top 10 Finding"),
    (r"jailbreak|dan\b|disallowed content|encoding attack", "LLM Jailbreak / Encoding Attack"),
    (r"prompt injection|indirect prompt|promptexfil", "Prompt Injection"),
    (r"data leak|leakreplay|training data", "LLM Sensitive Information Disclosure"),
    (r"misdirection|misleading", "LLM Misdirection / Data Poisoning"),
    (r"overreliance|blind trust", "LLM Overreliance"),
    (r"llm|large language model", "AI / LLM Security Finding"),
